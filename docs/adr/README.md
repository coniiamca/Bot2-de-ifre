...
| [011](ADR-011-otomatik-guncelleme.md) | Otomatik güncelleme: sunucu çeker, yalnız CI'ı yeşil commit, başarısızsa geri dönüş; gerçek para anahtarlarından önce insan onaylı kanal | Kabul |
| [012](ADR-012-islem-durumu-sqlite.md) | İşlem durumu SQLite'ta (demo aşaması, tek yazar, WAL); Postgres Faz 7 öncesi yeniden değerlendirilir | Kabul |
