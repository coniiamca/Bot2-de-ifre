...
def test_hmac_matches_the_binance_documentation_example() -> None:
    ...
    # the documentation's published example secret, not a credential
    secret = "NhqPtmdSJYdKjVHjA7PZj4Mge3R5YNiP1e3UZjInClVN65XAbvqqM6A7H5fATj0j"  # gitleaks:allow
    s = HmacSigner("key", secret)
